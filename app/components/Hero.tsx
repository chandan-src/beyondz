            ...
            <div className="container mx-auto  pt-8 sm:pt-12 md:pt-16 relative z-10">
                <div className="flex flex-col items-center">
                    ...
                    >
                        ...
                        >
                            <Link href="/training" className="hidden md:block font-thin bg-[#193CC4] text-white px-4 sm:px-5 md:px-6 py-1.5 sm:py-2 text-xs sm:text-sm hover:bg-blue-700 transition-colors rounded-sm flex items-center space-x-2">
